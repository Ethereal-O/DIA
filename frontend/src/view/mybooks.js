...
import { Mybookscontainer } from '../components/mybookscomponents';
...
class Mybooks extends React.Component{
    ...
    render() {
        return(
            <div className="mybooksmain">
                <div className="header">Here are my shelf.</div>
                <Mybookscontainer parent={this} data={this.state.alldata}></Mybookscontainer>
            </div>
        )
    }
}
